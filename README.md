...
Grab a free API key by signing up [here](https://videobreakdown.portal.azure-api.net/signin?ReturnUrl=%2Fget-started) and clicking on your account name, then "Profile." Replace "your_api_key" below with the API key for local testing. 
